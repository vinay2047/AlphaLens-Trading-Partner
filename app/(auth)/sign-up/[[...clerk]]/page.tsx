            ...
            <div className="relative p-8 sm:p-10 rounded-[2rem] bg-[#060606]/95 backdrop-blur-2xl border border-white/[0.08] shadow-[0_0_80px_rgba(0,0,0,0.6)] overflow-hidden">
                ...
                <div className="flex items-center justify-center gap-4 mb-8">
                    <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#10E55A]/10 border border-[#10E55A]/20">
                        <Zap className="w-3 h-3 text-[#10E55A]" />
                        <span className="text-[10px] font-bold text-[#10E55A] uppercase tracking-widest">Free Tier</span>
                    </div>
                    <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/5 border border-white/10">
                        <Lock className="w-3 h-3 text-gray-400" />
                        <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Encrypted</span>
                    </div>
                </div>
                ...
                <div className="mb-8 text-center">
                    ...
                    <p className="text-sm text-gray-400 font-medium">Join AlphaLens to unlock advanced trading.</p>
                </div>
                ...
                <div className="mt-6 pt-5 border-t border-white/[0.06] text-center">
                    <p className="text-sm text-gray-500">
                        ...
                        <a href="/sign-in" className="text-[#10E55A] hover:text-[#12f060] font-semibold transition-colors">
                            Sign in
                        </a>
                    </p>
                </div>
