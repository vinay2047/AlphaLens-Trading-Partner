...
const COLORS = ['#0FEDBE', '#5862FF', '#FDD458', '#FF495B', '#FF8243', '#D13BFF', '#3B82F6', '#10B981', '#F59E0B', '#EF4444'];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl border border-gray-600 bg-gray-800 p-5">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-sm font-bold text-gray-200">Portfolio Allocation</h3>
                </div>
            ...
            <div className="rounded-xl border border-gray-600 bg-gray-800 p-5">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-sm font-bold text-gray-200">P&L by Stock</h3>
                </div>
